...
+(NSDate *)date:(NSDate *)aDate andTime:(NSDate *)aTime
{
    ...
    NSDateComponents *catComponents = [NSDateComponents new];
...
-(NSDateComponents *)_datetimeComponents
{
    ...
    NSDateComponents *datetimeComponents = [calendar components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay |
...
-(NSInteger)todayDiffDays
{
    ...
    NSInteger days = [[calendar components:NSCalendarUnitDay fromDate:today toDate:compDate options:0] day];
...
-(NSDate *)dateAfterTodayAtInterval:(NSCalendarUnit)repeatInterval
{
    ...
    switch (repeatInterval) {
        ...
        case 256: // NSWeekCalendarUnit: iOS8 deprecatedになったが下位互換のため256の実数に置き換えた
...
{
    if (by24Time) {
        return LSTR(@"24TimeFormat");
    } else {
        return LSTR(@"12TimeFormat");
    }
}
...
//{
//    // TODO: Framework内のLocalizable.stringsが読めてない
//    // なのでWatchKit Extension内のLocalizable.stringsを読んでいる
//    NSDateFormatter *formatter = [NSDateFormatter new];
//    [formatter setDateFormat:[NSString stringWithFormat:@"%@ %@", LSTR(@"SendTimeStampToday"), LSTR(@"24TimeFormat")]];
//
...
//{
//    NSDateFormatter *formatter = [NSDateFormatter new];
//    [formatter setDateFormat:[NSString stringWithFormat:@"%@ %@", LSTR(@"SendTimeStampYesterday"), LSTR(@"24TimeFormat")]];
//
//    return [formatter stringFromDate:date];
//}
//
...
//{
//    NSDateFormatter *formatter = [NSDateFormatter new];
//    [formatter setDateFormat:[NSString stringWithFormat:@"%@ %@", [NSDateFormatter dateFormatFromTemplate:@"EEEE" options:0 locale:[NSLocale currentLocale]], LSTR(@"24TimeFormat")]];
//
//    return [formatter stringFromDate:date];
//}
//
...
//{
//    NSDateFormatter *formatter = [NSDateFormatter new];
//    [formatter setDateFormat:[NSString stringWithFormat:@"%@ %@", [NSDateFormatter dateFormatFromTemplate:@"EdMMM" options:0 locale:[NSLocale currentLocale]], LSTR(@"24TimeFormat")]];
//
//    return [formatter stringFromDate:date];
//}
